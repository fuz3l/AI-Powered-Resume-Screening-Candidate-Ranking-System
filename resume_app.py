...
# # Example predefined skill set (can be expanded)
# SKILL_SET = {"Python", "JavaScript", "Machine Learning", "Data Science", "Marketing", "SEO", "React"}
...
# # Compare skills in job description vs resume
